...
⭐ 실사용자 리뷰 & 반응
- 선택지가 구체적인 상품/서비스/브랜드일 때만 작성하세요 (예: 치킨 브랜드, 휴대폰 모델, 카메라 기종 등)
- 이런 경우 커뮤니티·구매자 리뷰 핵심을 bullet으로 요약하고, 각 후보별 긍정·부정 반응을 간결히 대조합니다
- 선택지가 행동/계획/추상적인 선택(예: 휴학 vs 복학, 공부 vs 쉬기 등)일 경우 이 섹션은 생략하고 다른 섹션(이유/효율성/가성비/핵심 근거)에 내용을 충분히 담으세요
- 섹션 전체 6줄 이내
